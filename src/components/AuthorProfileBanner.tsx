        ...
        <div className="flex flex-col lg:flex-row items-start justify-between gap-8">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-slate-700 leading-relaxed text-sm sm:text-base font-sans max-w-2xl">
              Pioneering computational earth systems, satellite radiometry downscaling, and public-interest urban heat democratization. Integrating Landsat-9, Sentinel-2, and thermodynamic microclimate models with sociological vulnerability indices to equip marginalized communities with audit-grade climate resilience evidence.
            </p>
