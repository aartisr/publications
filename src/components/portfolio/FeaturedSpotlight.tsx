...
import { BookOpen, ExternalLink, GitBranch, Layers, Sparkles, ArrowRight, Download, Printer, FileCode, Quote, Globe } from 'lucide-react';
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-4xl">
          ...
          <div className="mt-5 flex flex-wrap items-center gap-3">
            ...
            {/* Direct 3D GIS Map Explorer Jump Button */}
            <button
              onClick={() => {
                onRead(publication);
                setTimeout(() => {
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-emerald-700 hover:bg-emerald-800 text-white text-xs font-bold shadow-sm transition-all"
            >
              <Globe className="w-4 h-4 text-emerald-200" />
              <span>3D Google Earth GIS Map</span>
            </button>
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-amber-100 hover:bg-amber-200 border border-amber-300 text-amber-950 text-xs font-bold shadow-2xs transition-all"
            >
              <Download className="w-4 h-4 text-amber-800" />
              <span>Download Top 3 Formats</span>
            </button>
